...
(function($) {
    ...
    jQuery('.hb-menu nav').meanmenu({
        ...
        /*----------------------------------------*/
        // Li's Dropdown Menu
    $('.ht-currency-trigger, .ht-language-trigger, .hm-minicart-trigger, .cw-sub-menu').on('click', function(e) {
        e.preventDefault();
        $(this).toggleClass('is-active');
        $(this).siblings('.ht-currency, .ht-language, .minicart, .cw-sub-menu li').slideToggle();
    });
    /*----------------------------------------*/
    /* 03. Li's Sticky Menu Activation
    /*----------------------------------------*/

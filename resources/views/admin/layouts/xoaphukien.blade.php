{{-- modal xoa start --}}
<div class="modal fade" id="xoaPhuKien" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('xulyphukien') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer no-bd">
                    ...
                    <button type="submit" name="thaoTac" value="xóa phụ kiện" class="btn btn-danger">Đồng
                        ý</button>
                </div>
                @csrf
            </form>
